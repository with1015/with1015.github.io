...
위 2가지 목표를 달성하기 위해서, 저자들은 AlloX의 시스템 구조를 "Estimator", "Scheduler", "Placer"로 나누어 설계하게 됩니다.  
수정중...
